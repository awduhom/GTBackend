...
const JWT_SECRET = process.env.JWT_SECRET;    // Random string you invent (e.g., "supersecretkey123")
...
app.post('/api/photon-auth', (req, res) => {
    ...
    if (!clientToken) {
        return res.json({ ResultCode: 2, Message: "Missing Session Token" });
    }
    ...
    try {
        ...
        return res.json({ ResultCode: 2, Message: "Invalid or Expired Token" });
    }
});
